# [Alias] Session: [YYYY-MM-DD HH:MM]

> Active Role: [Alias]
> Repository: [repo name or path]
> MASTER-SPEC: [exists / does not exist]
...
### [HH:MM] [Topic / file / area reviewed]
...
<!-- INSTRUCTION: The system offers to generate a results document when:
     - 3+ substantive observations exist in the Session Log
     ...
     .agents/templates/role-session-results.md -->
