...
| `infrastructure/` | **[Infrastructure]** Deployment configuration: OpenTofu (`.tf`), Docker Compose, Caddyfile, deploy script, cloud-init, banks versionados (`hermes/banks/`). | Consult when modifying infrastructure provisioning, CI/CD pipeline, or service deployment configuration. |
