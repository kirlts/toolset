...
**Worker profiles:** perfiles Hermes dedicados por repositorio (`code-worker`, `research-worker`), cada uno con `terminal.cwd` al repo clonado y skills especificas. Tareas delegadas via Kanban `kanban_create()`.
