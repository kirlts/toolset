...
- **execute_code in cron mode**: flaky — worked 2026-08-06 but was blocked again 2026-08-10. In cron mode go straight to `terminal()` with inline Python; don't burn an iteration attempting execute_code first.
